...
static const input_function_metadata_t input_function_metadata[] = {
    ...
    {readline_cmd_t::forward_nextword, L"forward-nextword"},
    {readline_cmd_t::backward_nextword, L"backward-nextword"},
    {readline_cmd_t::forward_bignextword, L"forward-bignextword"},
    {readline_cmd_t::backward_bignextword, L"backward-bignextword"},
    {readline_cmd_t::forward_endword, L"forward-endword"},
    {readline_cmd_t::backward_endword, L"backward-endword"},
    {readline_cmd_t::forward_endword, L"forward-bigendword"},
    {readline_cmd_t::backward_endword, L"backward-bigendword"},
    ...
    {readline_cmd_t::clear_operator, L"clear_operator"},
    {readline_cmd_t::set_operator_copy, L"set-operator-copy"},
    {readline_cmd_t::set_operator_kill, L"set-operator-kill"},
